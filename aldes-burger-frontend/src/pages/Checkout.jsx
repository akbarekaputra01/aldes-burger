...
function Checkout() {
  ...
  return (
    <main className="min-h-screen w-full bg-aldesCream font-sans text-black pb-20">
      {/* Header */}
      <header className="sticky top-0 z-[60] bg-aldesRed text-white shadow-sm">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex w-1/3 items-center justify-end gap-2 sm:gap-4">
            ...
            <div className="relative p-2">
              ...
              <span className="absolute -right-1 -top-1 rounded-2xl bg-aldesRed px-1.5 text-xs font-bold text-white ring-2 ring-aldesCream">{cartCount}</span>
            </div>
