...
function AddressBook() {
  ...
  {!form.postal_code && <p className="text-sm text-gray-500">Please select or type a postal code first to see street suggestions.</p>}
  {form.district && postalCodeOptions.length === 0 && <p className="text-sm text-gray-500">Postal code recommendations are unavailable, please type 5 digits manually.</p>}
