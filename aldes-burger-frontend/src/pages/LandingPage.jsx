      ...
      <section className="mx-auto grid w-full max-w-7xl gap-8 px-4 pb-12 pt-8 sm:px-6 lg:grid-cols-2 lg:px-8 lg:pt-14">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              to="/menus"
              className="rounded-3xl bg-orange-500 px-6 py-3 font-semibold text-white shadow-md transition hover:-translate-y-0.5 hover:bg-orange-600"
            >
              Start Customizing
            </Link>
            <Link
              to="/transactions"
              className="rounded-3xl border border-orange-300 bg-white px-6 py-3 font-semibold text-orange-600 transition hover:bg-orange-100"
            >
              Track Orders
            </Link>
          </div>
          ...
          {steps.map((step) => {
            ...
            return (
              <article key={step.id} className="rounded-3xl bg-white p-5 shadow-sm">
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-orange-100 text-orange-600">
      ...
      <footer className="border-t border-orange-100 bg-white">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 px-4 py-6 text-sm text-gray-600 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="hover:text-orange-600">TikTok</a>
